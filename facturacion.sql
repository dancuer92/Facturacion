...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-12-2015 a las 23:44:40
...
`cod_articulo` int(11) NOT NULL,
  ...
  `cod_proveedor` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `fecha_ingreso` varchar(15) COLLATE utf8_spanish_ci NOT NULL
...
INSERT INTO `ciudad` (`codigo_ciudad`, `cod_departamento`, `nombre_ciudad`) VALUES
(1, 1, 'Leticia'),
(2, 1, 'Puerto Nariño'),
(3, 2, 'Abejorral'),
(4, 2, 'Abriaquí'),
...
INSERT INTO `cliente` (`documento`, `cod_tipo_documento`, `nombres`, `apellidos`, `direccion`, `cod_ciudad`, `telefono`, `correo`) VALUES
('1090', 1, 'daniel', 'cuervo', 'dskljfn', 1, '09438', 'ads@ad.co'),
('1234', 1, 'sdfg', 'mbn', '', 3, '', ''),
('134', 1, 'sadg', 'adfgggf', '', 1, '', ''),
('234', 2, 'hol', 'soy', 'dlk', 2, '', ''),
('365', 1, 'sdfh', 'sdh', 'ethh', 2, '', ''),
('555', 1, 'qwer', 'rery', '', 26, '', ''),
('567', 1, 'qrqwe', 'dxf', '', 345, '', ''),
('5677', 1, 'qewr', 'tyu', '', 87, '', ''),
('876', 1, 'her', 'hdfhf', '', 67, '', '');
...
CREATE TABLE IF NOT EXISTS `detalle_factura` (
  `cod_factura` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `cod_articulo` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `devolucion` (
  `cod_detalle_factura` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `cod_detalle_articulo` int(11) NOT NULL,
  `motivo` varchar(15) COLLATE utf8_spanish_ci NOT NULL,
...
CREATE TABLE IF NOT EXISTS `factura` (
  `cod_factura` varchar(20) COLLATE utf8_spanish_ci NOT NULL,
  `cod_cliente` varchar(15) COLLATE utf8_spanish_ci NOT NULL,
  `nombre_empleado` varchar(30) COLLATE utf8_spanish_ci NOT NULL,
  `fecha_facturacion` varchar(15) COLLATE utf8_spanish_ci NOT NULL,
...
`cod_forma_pago` int(11) NOT NULL,
  `descripcion_forma_pago` varchar(20) COLLATE utf8_spanish_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `precio` (
  ...
  `producto_peso` int(11) NOT NULL,
  `producto_cantidad_chorizos` int(11) NOT NULL,
...
INSERT INTO `precio` (`cod_cliente`, `producto_nombre`, `producto_peso`, `producto_cantidad_chorizos`, `precio`) VALUES
('1090', 'chorizos', 250, 5, 6000),
('1090', 'chorizos', 340, 5, 6000),
('1090', 'chorizos', 400, 7, 6000),
('1090', 'chorizos', 500, 7, 7500),
('1090', 'chorizos santarrosanos', 250, 5, 10000),
('1090', 'chorizos santarrosanos', 500, 8, 8000),
('1234', 'chorizos', 250, 5, 5000),
('1234', 'chorizos', 340, 5, 200000),
('134', 'chorizos', 250, 5, 2500),
('234', 'chorizos', 250, 5, 12000),
('234', 'chorizos', 340, 5, 12000),
('234', 'chorizos santarrosanos', 250, 5, 12000),
('234', 'chorizos santarrosanos', 500, 8, 11000);
...
INSERT INTO `producto` (`nombre`, `peso`, `num_chorizos`, `precio_publico`, `cant_inventario`) VALUES
('chorizos', 250, 5, 0, 0),
('chorizos', 340, 5, 0, 0),
('chorizos', 400, 7, 0, 0),
('chorizos', 500, 7, 0, 0),
('chorizos santarrosanos', 250, 5, 0, 0),
('chorizos santarrosanos', 500, 8, 12000, 12);
...
CREATE TABLE IF NOT EXISTS `proveedor` (
  ...
  `nombre_comercial` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
  `direccion` varchar(30) COLLATE utf8_spanish_ci DEFAULT NULL,
  `cod_ciudad` int(11) NOT NULL,
  `telefono` varchar(20) COLLATE utf8_spanish_ci DEFAULT NULL,
  `correo` varchar(50) COLLATE utf8_spanish_ci DEFAULT NULL,
...
INSERT INTO `proveedor` (`documento`, `cod_tipo_documento`, `nombre`, `apellido`, `nombre_comercial`, `direccion`, `cod_ciudad`, `telefono`, `correo`, `descripcion`) VALUES
('213453', 4, 'asdf', 'qwert', 'tyu', '', 26, '', '', ''),
('789', 1, 'qwerty', 'asdf', 'admin', '', 876, '', '', 'ingredientes');
...
INSERT INTO `tipo_de_documento` (`cod_tipo_documento`, `descripcion`) VALUES
(1, 'CC'),
(2, 'TI'),
(3, 'RC'),
(4, 'NIT'),
...
ALTER TABLE `articulo`
 ADD PRIMARY KEY (`cod_articulo`), ADD KEY `fk_tipo_articulo` (`cod_tipo_articulo`), ADD KEY `fk_proveedor` (`cod_proveedor`);

--
-- Indices de la tabla `ciudad`
--
ALTER TABLE `ciudad`
 ADD PRIMARY KEY (`codigo_ciudad`), ADD KEY `fk_departamento` (`cod_departamento`);

--
-- Indices de la tabla `cliente`
--
ALTER TABLE `cliente`
 ADD PRIMARY KEY (`documento`), ADD KEY `fk_tipo_documento` (`cod_tipo_documento`), ADD KEY `fk_ciudad` (`cod_ciudad`);
...
ALTER TABLE `detalle_factura`
 ADD PRIMARY KEY (`cod_factura`,`cod_articulo`), ADD KEY `fk_factura` (`cod_factura`), ADD KEY `fk_articulo` (`cod_articulo`);

--
-- Indices de la tabla `devolucion`
--
ALTER TABLE `devolucion`
 ADD PRIMARY KEY (`cod_detalle_factura`,`cod_detalle_articulo`), ADD KEY `fk_detalle_factura` (`cod_detalle_factura`), ADD KEY `fk_detalle_articulo` (`cod_detalle_articulo`);

--
-- Indices de la tabla `factura`
--
ALTER TABLE `factura`
 ADD PRIMARY KEY (`cod_factura`), ADD KEY `fk_cliente` (`cod_cliente`), ADD KEY `fk_forma_pago` (`cod_forma_pago`);
...
--
ALTER TABLE `precio`
 ADD PRIMARY KEY (`cod_cliente`,`producto_nombre`,`producto_peso`,`producto_cantidad_chorizos`), ADD KEY `fk_cliente2` (`cod_cliente`), ADD KEY `fk_producto2` (`producto_nombre`,`producto_peso`,`producto_cantidad_chorizos`);

--
-- Indices de la tabla `producto`
--
ALTER TABLE `producto`
 ADD PRIMARY KEY (`nombre`,`peso`,`num_chorizos`);

--
-- Indices de la tabla `proveedor`
--
ALTER TABLE `proveedor`
 ADD PRIMARY KEY (`documento`), ADD KEY `fk_ciudad2` (`cod_ciudad`), ADD KEY `fk_tipo_documento2` (`cod_tipo_documento`);

--
-- Indices de la tabla `tipo_articulo`
--
ALTER TABLE `tipo_articulo`
 ADD PRIMARY KEY (`cod_tipo_articulo`);
...
--
ALTER TABLE `forma_de_pago`
MODIFY `cod_forma_pago` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tipo_articulo`
--
ALTER TABLE `tipo_articulo`
MODIFY `cod_tipo_articulo` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT de la tabla `tipo_de_documento`
--
ALTER TABLE `tipo_de_documento`
MODIFY `cod_tipo_documento` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=8;
--
...
--
ALTER TABLE `articulo`
ADD CONSTRAINT `fk_proveedor` FOREIGN KEY (`cod_proveedor`) REFERENCES `proveedor` (`documento`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fk_tipo_articulo` FOREIGN KEY (`cod_tipo_articulo`) REFERENCES `tipo_articulo` (`cod_tipo_articulo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `ciudad`
--
ALTER TABLE `ciudad`
ADD CONSTRAINT `fk_departamento` FOREIGN KEY (`cod_departamento`) REFERENCES `departamento` (`cod_departamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `cliente`
--
ALTER TABLE `cliente`
ADD CONSTRAINT `fk_ciudad` FOREIGN KEY (`cod_ciudad`) REFERENCES `ciudad` (`codigo_ciudad`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fk_tipo_documento` FOREIGN KEY (`cod_tipo_documento`) REFERENCES `tipo_de_documento` (`cod_tipo_documento`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `detalle_factura`
--
ALTER TABLE `detalle_factura`
ADD CONSTRAINT `fk_articulo` FOREIGN KEY (`cod_articulo`) REFERENCES `articulo` (`cod_articulo`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fk_factura` FOREIGN KEY (`cod_factura`) REFERENCES `factura` (`cod_factura`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `devolucion`
--
ALTER TABLE `devolucion`
ADD CONSTRAINT `fk_detalle_articulo` FOREIGN KEY (`cod_detalle_articulo`) REFERENCES `detalle_factura` (`cod_articulo`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fk_detalle_factura` FOREIGN KEY (`cod_detalle_factura`) REFERENCES `detalle_factura` (`cod_factura`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `factura`
--
ALTER TABLE `factura`
ADD CONSTRAINT `fk_cliente` FOREIGN KEY (`cod_cliente`) REFERENCES `cliente` (`documento`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fk_forma_pago` FOREIGN KEY (`cod_forma_pago`) REFERENCES `forma_de_pago` (`cod_forma_pago`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `precio`
--
ALTER TABLE `precio`
ADD CONSTRAINT `fk_cliente2` FOREIGN KEY (`cod_cliente`) REFERENCES `cliente` (`documento`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fk_producto2` FOREIGN KEY (`producto_nombre`, `producto_peso`, `producto_cantidad_chorizos`) REFERENCES `producto` (`nombre`, `peso`, `num_chorizos`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE `proveedor`
ADD CONSTRAINT `fk_ciudad2` FOREIGN KEY (`cod_ciudad`) REFERENCES `ciudad` (`codigo_ciudad`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `fk_tipo_documento2` FOREIGN KEY (`cod_tipo_documento`) REFERENCES `tipo_de_documento` (`cod_tipo_documento`) ON DELETE CASCADE ON UPDATE CASCADE;
